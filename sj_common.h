...
public:
	...
	****************************************/
	...
	ofxGuiGroup Group_FFT;
		ofxToggle b_update_signal;
		ofxToggle b_window_Hanning;
		ofxToggle b_window_Tukey;
		ofxFloatSlider Tukey_alpha;
		ofxFloatSlider DrawAudioSignal_H;
		ofxColorSlider col_Audio;
		ofxColorSlider col_Window;
		ofxFloatSlider alpha_of_BackImg;
		ofxFloatSlider Draw_LineWidth;
		ofxToggle b_Draw_Window;
